...
train_pairs = np.concatenate((train_pairs_one, train_pairs_two))
val_pairs = np.concatenate((val_pairs_one, val_pairs_two))
...
def dotfit():
    ...
    model.fit(
            ...
            steps_per_epoch = train_pairs.shape[0]//config['batch_size'],
            batch_size = config['batch_size'],
            callbacks = _callbacks,
            validation_data = val_generator,
            validation_steps = val_pairs.shape[0]//config['batch_size'],
