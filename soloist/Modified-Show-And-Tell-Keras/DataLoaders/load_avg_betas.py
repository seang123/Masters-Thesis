...
#print(" > visual region masks loaded from file") 
    ...
    while True:
        for i in range(0, N, batch_size):
            ...
            betas_data = np.zeros((nsd_key.shape[0], 62756))
            ...
            cap_vector = keras.preprocessing.sequence.pad_sequences(cap_seqs, maxlen = max_length, truncating = 'post', padding = 'post')
