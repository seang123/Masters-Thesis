...
class Evaluate():
    ...
    def __init__(self, save_dir):
        ...
        # load features
        self.image_features = np.memmap(filename="img_features_binary", dtype = 'float32', mode='r', order ='C', shape = (73000, 64, 2048) )
    ...
    def gen_prediction(self, image_id=None):
        ...
        image_features = tf.reshape(image_features, (1, 64, 2048))
